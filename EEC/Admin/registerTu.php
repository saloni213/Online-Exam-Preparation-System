...
if ($count>0)
{
	...
	echo "<div class=head1>Login Id Already Exists</div>";
       /* echo "<div align='right' valign='top'><strong><a href='../index.php'> Home </a>   <a href='signout.php'> Signout </a></strong></div>";

	exit;*/
}
 else {
    
$rs4=$dbhandler->query("select * from user where email='$email'");
$count4 = $rs4->rowcount();
if ($count4>0)
{
...
if($pass==$cpass)
{
$query="insert into user(login,pass,username,address,city,phone,email,isStudent,isTutor) values('$lid','$pass','$name','$address','$city','$phone','$email',0,1)";
$rs=$dbhandler->query($query)or die("Could Not Perform the Query");
echo "<div class=head1>Tutor Id $lid is Created Sucessfully</div>";
...
$pass
   ...
   else
   {
    ...
    echo "<div class=head1>ENTER VALID PASSWORD</div>";
      echo "<div align='center' valign='top'><strong><a href='registerTu.php'> Register again </a> <br><br>  <a href='../index.php'> Login </a></strong></div>";
...
?>
    ...
    <div class="container-fluid page-body-wrapper full-page-wrapper">
      <div class="content-wrapper d-flex align-items-center auth px-0" style="background: #D0D0D0">
        ...
        <!--      <h4>New here?</h4>
            ...
            -->  <form class="pt-3"  name="form1" method="post" action="registerTu.php" onSubmit="return check();">
                <div class="form-group">
                  <input type="text" name="lid" class="form-control form-control-lg" id="exampleInputUserId1" placeholder="UserId">
                </div>
                  <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  <input type="password"  name="cpass" class="form-control form-control-lg" id="exampleInputcPassword1" placeholder="Confirm Password">
                </div>
  ...
  <script src="../style/js/template.js"></script><!DOCTYPE html>
<!--
To change this license header, choose License Headers in Project Properties.
To change this template file, choose Tools | Templates
and open the template in the editor.
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3"  name="form1" method="post" action="registerTutor.php" onSubmit="return check();">
                <div class="form-group">
                  <input type="text" name="lid" pattern="[a-zA-Z]{5}[a-zA-Z]*" class="form-control form-control-lg" id="exampleInputUserId1" placeholder="UserId">
                </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                  <input type="email" name="email" pattern="[a-z]{3,10}[0-9]{0,5}@gmail.com" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email">
                </div>
                <div class="form-group">
