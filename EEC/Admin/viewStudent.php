...
$sql = "SELECT * FROM user where isStudent='1' && isTutor='0'";
...
<div class="container">
  <div class="card mt-5">
    <div class="card-header" style="background: #D0D0D0">
      <h2 align="center" style="font-size: 35px; font-style: bold;">Students</h2>
    </div>
    <div class="card-body" >
      <table class="table table-striped table-responsive-xl">
        <tr>
          <th style="font-size: 20px; font-style: bold;">ID</th>
          <th style="font-size: 20px; font-style: bold;">Login Id</th>
        ...
        <?php foreach($people as $person): ?>
          <tr>
            ...
            <td><?= $person->email; ?></td>
            <td>
              <a href="editStu.php?id=<?= $person->user_id ?>" class="btn btn-info">Edit</a>
              <a onclick="return confirm('Are you sure you want to delete this entry?')" href="deleteStu.php?id=<?= $person->user_id ?>" class='btn btn-danger'>Delete</a>
            </td>
          </tr>
        <?php endforeach; ?>
      </table>
