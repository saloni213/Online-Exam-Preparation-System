...
$rs=$dbhandler->query("select * from user where login='$login'");
...
//echo "<div class=head1 align='center'>Email is succesfully sent to $lid</div>";


   
   extract($_POST);
    $mailto = "blackpanther412563@gmail.com";
    $mailSub = $mail_sub;
    $mailMsg = $mail_msg;
   $msg="<html>
<head>
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4 style="font-size: 30px; font-style: bold;" align="center">Message</h4>
